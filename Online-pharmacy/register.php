...
<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>This $f_name is not vaild</b>
</div>";
        exit();
    }
    ...
    if (!preg_match($name,$l_name)){
        echo "<div class='alert alert-warning'>
<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>This $l_name is not vaild</b>
</div>";
        exit();
    }
    ...
    if (!preg_match($emailvalidation,$email)){
        echo "<div class='alert alert-warning'>
<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>$email address is not vaild</b>
</div>";
        exit();
    }
...
<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>$mobile is not valid</b>
    ...
    if (!(strlen($mobile)==10)){
        echo "<div class='alert alert-warning'>
<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>mobile number should be 10</b>
</div>";
        exit();
    }
...
<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Email is already available try another email</b>
</div>";
        exit();
    }
    else{
