...
<div class="container-fluid">
    ...
    <form class="form-horizontal" action="" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="phar_id" placeholder="" name="phar_id" >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="phar_name" placeholder="" name="phar_name" >
            </div>
        </div>
...
if(isset($_REQUEST["submit"]))
{
    ...
    $q="insert into pharmacist(phar_name,email,username,phone_no,qualification,address) VALUES 
    ('$phar_name','$email','$username','$phone_no','$qualification','$address')";
