...
$q="select * from cashier WHERE cashier_id=$cashier_id";
...
<div class="container-fluid">
    ...
    <form class="form-horizontal" action="" method="post">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="Cashier ID">Cashier ID:</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="cashier_id" readonly placeholder="" name="cashier_id" value="<?php echo $r["cashier_id"];?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="cashier_name" placeholder="" name="cashier_name" value="<?php echo $r["cashier_name"];?>">
            </div>
        </div>
...
if (isset($_POST["update"]))
{
    ...
    echo $q = "update cashier set cashier_name ='$cashier_name', email='$email',phone_no='$phone_no',address='$address' where cashier_id=$cashier_id";
