    ...
    <table class="table table-bordered">
        ...
        while($r=mysqli_fetch_array($res))
        {
            ...
            <tr>
                ...
                <td><a href="deleteBrand.php?n=<?php echo $r["brand_id"];?>" ><img src="img/delete.png" height="50px" width="50px"/> </a></td>
                <td><a href="updateBrand.php?n=<?php echo $r["brand_id"];?>" ><img src="img/Update-icon.png" height="50px" width="50px"/> </a> </td>
            </tr>
            <?php
        }
        ?>
