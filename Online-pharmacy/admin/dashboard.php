...
<div class="container-fluid">
    ...
    <nav class="navbar navbar-inverse">
        ...
        <ul class="nav navbar-nav">
            <li><a href="adminView.php"><li style="padding-top: 6px;color: white; font-size: large;">View Medicines</li></a>
            ...
            <li><div class="dropdown " ><button class=" dropdown-toggle navbar navbar-inverse" data-toggle="dropdown" style="border: 0px; padding-top: 15px;color: white; font-size: large;">Pharmacist<span class="caret"></span></button>
                    <ul class="dropdown-menu">
                        <li class=" "><a href="pharmacistAdd.php">Add</a></li>
    ...
    <div class="row">
        <div class="col-sm-2">
            <ul class="list-group" style="font-size: large">
                <a class="list-group-item" href="adminView.php">View Medicines</a>
                <a class="list-group-item " href="pharmacistAdd.php">Pharmacist</a>
