...
<nav class="navbar navbar-inverse">
    ...
    <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <select class="from-control" name="cat">
                    <?php
...
if(isset($_REQUEST["submit"]))
{
    ...
    $dose=$_REQUEST["dose"];
    $q="insert into products(product_image,product_title,product_com, cat_id, brand_id,batch_no,man_date,exp_date,quantity,product_price,product_desc,dose) VALUES 
    ('$med_img','$pro_title','$pro_com','$cat_id','$brand_id','$batch_no','$man_date','$exp_date','$quantiy','$pro_price','$pro_desc','$dose')";
